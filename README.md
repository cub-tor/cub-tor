...
- <ins>Gestión de Departamentos</ins> : A simple desktop application to display CRUD operations related to the management of company departments. I used NetBeans, Java and a MySQL database. It works in localhost
